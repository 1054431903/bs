...
mock.onGet(/\/(posts|users|types|farmerarchives|comments)$/).reply(({ params = { page: 1, perPage: 10 }, url }) => {
...
mock.onGet('/farmerarchives/grid').reply(200, {
  'options': {
    'sort': 'id',
    'create': true,
    'update': true,
  ...
  'columns': [
    ...
    {
      'text': 'PeasentLinkPhone',
      'value': 'linkphone'
    },
    {
      'text': 'PeasentAddressCode',
      left: true,
      'value': 'addresscode'
    },
    {
