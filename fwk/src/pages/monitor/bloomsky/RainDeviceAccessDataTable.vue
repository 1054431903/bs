<template style="background-color:#fff">
  <div class="card--table pt-3 px-0" style="min-height:500px;">
    <v-data-table v-if="tableFlag" height="800px" :headers="table.headers" :items="table.items" rows-per-page-text="每页" :rows-per-page-items="table.pagination" class="elevation-1" no-data-text="未找到相应数据." no-results-text="没有匹配的数据.">
    ...
    <div v-else style="position:absolute;left:0;right:0;bottom:0;top:0;z-index:9999;opacity:0.3;text-align:center;line-height:800px;">
