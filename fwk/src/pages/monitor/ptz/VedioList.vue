<template>
  <v-container style="background-color:#fff">
    ...
    <v-layout row
      ...
      <v-flex xs6>
        <vc-schema-form :schema="search.schema"
      ...
      <v-flex xs2>
        <v-btn color="primary"
               small
               style="margin-left:30px;">设置</v-btn>
      </v-flex>
    </v-layout>
    <v-layout row
              wrap>
      <div style="width:100%;background-color:#fff;cursor:pointer"
           class="pt-3">
        <div style="float:left;margin-left:10px;"
             ...
             class="my-3">
          <v-card width="160px">
            <v-img src="../../../../static/img/1.png"
                   height="150px">
              <div style="width:40%;"></div>
              <v-icon x-large>slideshow</v-icon>
            </v-img>
