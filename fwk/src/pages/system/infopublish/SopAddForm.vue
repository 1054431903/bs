              ...
              <v-stepper-content :step="step.no"
                ...
                <div v-else>
                  <div v-for="(inforDetail, index) in informationDetails"
                    ...
                    <div class="inforDetailShow">
                      <v-layout row
                                wrap>
                        <v-flex xs8>
                          <div class="title detailtitle">{{ inforDetail.name }}</div>
                        </v-flex>
                        <v-flex xs4
                                text-sm-right>
                          <v-btn title="编辑"
                      ...
                      <v-layout row
                        ...
                        <v-flex xs12
                                class="pr-2">
                          <div v-html="inforDetail.content"></div>
                        </v-flex>
                      </v-layout>
                    </div>
                  </div>
                  <div class="inforDetailForm"
                    ...
                    <v-layout row
                      ...
                      <v-flex sm12
                        ...
                        <v-btn :color="theme"
                               dark
                               @click="saveInformationDetial">保存</v-btn>
                      </v-flex>
                    </v-layout>
                  </div>
                  ...
                  <div class="text-sm-center"
                    ...
                    <!-- <v-btn :color="theme" @click="editOrAddFormShow = true">完成</v-btn> -->
                  </div>
                </div>
                <v-divider></v-divider>
                <div class="text-sm-center">
                  ...
                  <v-btn color="warning"
                         v-if="informationDetails.length > 0 && step.no === 2"
    ...
    nextStep (n) {
      ...
      if (n === 1) {
        ...
        if (this.information.id) {
          ...
          excuteApis(this.information, global.constant.systemApis, 'information', 'add').then(data => {
            let res = data.data
            if (res.flag === 1) {
              this.information = res.data
              this.fetchData()
